...
## [0.5.4](https://github.com/so1ve/gpui-markup/compare/v0.5.3...v0.5.4) - 2026-09-24

### Added

- improve auto complete

## [0.5.3](https://github.com/so1ve/gpui-markup/compare/v0.5.2...v0.5.3) - 2026-09-24

### Other

- fix clippy
- use shared workflows
- add compatibility test for each gpui distros
